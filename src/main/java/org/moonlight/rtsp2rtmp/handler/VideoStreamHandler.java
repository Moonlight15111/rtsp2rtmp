...
import org.moonlight.rtsp2rtmp.vo.Device;
import org.moonlight.rtsp2rtmp.vo.HlsStreamUrlQueryVO;
import org.moonlight.rtsp2rtmp.vo.RtspStreamUrlQueryVO;
import org.moonlight.rtsp2rtmp.vo.StreamUrlInfo;
import lombok.Data;
 ...
 * 〈功能简述〉<br>
 * 〈〉
 * DSS - 大华DSS平台，登录、获取token、更新token、获取设备信息、获取RTSP、HLS视频流地址
 * @author Moonlight
