package org.moonlight.dssdemo.hikvision;
...
import org.moonlight.dssdemo.config.DllLibraryPath;

//SDK接口说明,HCNetSDK.dll
public interface HCNetSDK extends StdCallLibrary {

    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary(DllLibraryPath.HIKVISION_DLL_PATH_PREFIX + "HCNetSDK.dll", HCNetSDK.class);
